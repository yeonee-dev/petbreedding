...
<body>
		...
		<section class="section">
			<form action="" id="joinFrm" class="joinFrm">
				...
				<table>
					...
					<tr>
						<td colspan="2"><input type="text" class="basicTextInput"
							id="name" name="name" readonly value="${name }">
						</td>
					</tr>
					...
					<tr>
						<td colspan="2"><input type="text" class="basicTextInput"
							id="nickName" readonly name="nickname" value="${nickname }">
					...
					<tr>
						<td><input type="text" placeholder="핸드폰 번호를 '-'없이 입력해주세요."
							id="hp" class="getChkMsg_bar basicTextInput" name="tel" >
						</td>
						<td>
					...
					<input type="hidden" name="naverlogin" value="Y" />
	...
	<!-- script -->
	<script type="text/javascript" src="${path}/resources/js/user/uMember/naverJoin.js"></script>
</body>
</html>